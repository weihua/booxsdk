...
enum LibraryFilterType
{
    ...
    LIBRARY_FILTER_ITEMS_OPENED,
    LIBRARY_FILTER_ITEMS_NOT_OPENED,
    LIBRARY_FILTER_STORE_ITEMS_ALL,
    LIBRARY_FILTER_STORE_ITEMS_READING,
    LIBRARY_FILTER_STORE_ITEMS_READED,
    LIBRARY_FILTER_STORE_ITEMS_NEW
};
...
enum AnnotationMode
{
    ...
    EXPORT_ANNOTATIONS,
    PDF_MERGE_ANNOTATIONS,
    UNKNOWN_ANNOTATION_MODE
};

enum HighlightMode
{
    INVALID_HIGHLIGHT_MODE = 49,
    ADD_HIGHLIGHT = 50,
    DELETE_HIGHLIGHT,
    DISPLAY_ALL_HIGHLIGHTS,
    UNKNOWN_HIGHLIGHT_MODE
};
