#include "onyx/ui/georgian_keyboard_layout.h"
#include "onyx/sys/sys.h"

namespace ui
{

GeorgianKeyboardLayout::GeorgianKeyboardLayout()
: KeyboardLayout()
{
    initCode();
    initShiftMap();
...
QSize GeorgianKeyboardLayout::getKeySize(int code)
{
...
void GeorgianKeyboardLayout::initCode()
{
    code_vector_.clear();
...
void GeorgianKeyboardLayout::initKeys()
{
    // resize keys
    keys_.clear();
    keys_.resize(5);
