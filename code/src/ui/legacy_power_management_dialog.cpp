...
LegacyPowerManagementDialog::LegacyPowerManagementDialog(QWidget *parent, SysStatus & ref)
    : OnyxDialog(parent)
    , status_(ref)
...
LegacyPowerManagementDialog::~LegacyPowerManagementDialog(void)
{
}

int LegacyPowerManagementDialog::exec()
{
    shadows_.show(true);
    show();
...
void LegacyPowerManagementDialog::keyPressEvent(QKeyEvent *ke)
{
    ke->accept();
}

void LegacyPowerManagementDialog::keyReleaseEvent(QKeyEvent *ke)
{
    QWidget *wnd = 0;
    ke->accept();
    switch (ke->key())
...
void LegacyPowerManagementDialog::createLayout()
{
...
void LegacyPowerManagementDialog::onStandbyButtonChanged(bool state)
{
...
void LegacyPowerManagementDialog::onShutdownButtonChanged(bool state)
{
...
bool LegacyPowerManagementDialog::event(QEvent* qe)
{
